...
<div id="home">
    <div class="posts">
        <nav class="art-list">
		  ...
		  <?php
				$db = new Db();
				$query = "SELECT * FROM info_post ORDER BY tanggal DESC";
				...
				foreach ($results as $result)
				{
					...
					<li class='art-list-item'>
						...
						<p>
						  <a href='edit_post.php?id=".htmlspecialchars($result['ID'])."'>Edit</a> | <a href='#' onclick='ConfirmDelete(".htmlspecialchars($result['ID']).",\"".$_SESSION['token']."\")'>Hapus</a>
						</p>
					</li>";
				}
			?>
